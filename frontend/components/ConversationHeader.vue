<template>
  <div 
    ...
    class="flex bg-white border-b border-gray-200 px-4 lg:px-6 py-3 lg:py-4 items-center justify-between flex-shrink-0 cursor-pointer hover:bg-gray-50 transition-colors"
