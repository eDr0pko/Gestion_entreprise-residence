...
class IncidentController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            // Correction : si pieces_jointes existe déjà dans detailsArr (proxy), on l'utilise, sinon on prend $pieces
            $pj = $detailsArr['pieces_jointes'] ?? $pieces;
            // Toujours encoder en JSON pour la BDD
            if (!is_string($pj)) {
                $pj = json_encode($pj);
            }
